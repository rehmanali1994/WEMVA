...
## Define Parameters
which_dataset = 1; # 1 for dataset released in TCI paper 
                   # 2 for Rat 10 - Acquisition 3
                   # 3 for Rat 11 - Acquisition 2
...
rng_min = 1450; rng_max = 1700; # Sound Speed Display Range [m/s]

# Load File and Original k-Wave Simulation Grid
if which_dataset == 1: # Dataset Released in TCI Paper
    load_filename = '../Datasets/RatAbdomenL12-3v.mat'; 
elif which_dataset == 2: # Rat 10 - Acquisition 3
    load_filename = '../Datasets/Rat10_Acq3.mat'; 
elif which_dataset == 3: # Rat 11 - Acquisition 2
    load_filename = '../Datasets/Rat11_Acq2.mat'; 
...
TGC = np.sqrt(z[1::,np.newaxis]**2 + (np.max(z)/4)**2); 
...
plt.ion(); plt.figure(figsize=(15,9))
for iteration in range(max_iterations):
    ...
    # Save Data / Figures
    if which_dataset == 1: # Dataset Released in TCI Paper
        plt.savefig('../Figures/RatAbdomen/RatAbdomenL12-3v/Recon'+str(iteration)+'.png'); 
    elif which_dataset == 2: # Rat 10 - Acquisition 3
        plt.savefig('../Figures/RatAbdomen/Rat10_Acq3/Recon'+str(iteration)+'.png'); 
    elif which_dataset == 3: # Rat 11 - Acquisition 2
        plt.savefig('../Figures/RatAbdomen/Rat11_Acq2/Recon'+str(iteration)+'.png'); 
...
if which_dataset == 1: # Dataset Released in TCI Paper
    savemat('../Figures/RatAbdomen/RatAbdomenL12-3v/FullHistory.mat', data_to_save); 
elif which_dataset == 2: # Rat 10 - Acquisition 3
    savemat('../Figures/RatAbdomen/Rat10_Acq3/FullHistory.mat', data_to_save); 
elif which_dataset == 3: # Rat 11 - Acquisition 2
    savemat('../Figures/RatAbdomen/Rat11_Acq2/FullHistory.mat', data_to_save); 
